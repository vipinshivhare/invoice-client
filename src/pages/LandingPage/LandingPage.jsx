    ...
    return (
        <>
                    ...
                    <div className="row py-lg-5">
                        <div className="col-lg-9 col-md-10 mx-auto">
                            ...
                            <p className="lead mb-5" style={{ fontSize: '1.3rem' }}>
                                Stop wrestling with spreadsheets. BillCloud helps you create and send beautiful invoices in minutes, so you get paid faster.
                            </p>
                            <p>
            ...
            <section id="features" className="py-5">
                <div className="container">
                    <h2 className="text-center mb-5 display-5 fw-bold">Why Choose BillCloud?</h2>
                    {/* Feature 1 */}
            ...
            <section id="generate-invoice" className="py-5 text-center bg-primary text-white">
                <div className="container">
                    ...
                    <p className="lead mb-4 mx-auto" style={{ maxWidth: '600px' }}>
                        Join thousands of freelancers and small businesses who trust BillCloud.
            ...
            <footer className="py-5 bg-dark text-white-50">
                <div className="container text-center">
                    <Logo />
                    <p className="text-white fw-bold mt-2">BillCloud</p>
                    <p className="mb-0">
                        &copy; {new Date().getFullYear()} BillCloud. All Rights Reserved.
                    </p>
